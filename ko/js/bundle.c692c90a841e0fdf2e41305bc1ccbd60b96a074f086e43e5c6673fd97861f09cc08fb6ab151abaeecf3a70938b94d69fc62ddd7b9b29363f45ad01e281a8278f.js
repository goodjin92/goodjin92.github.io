...
const defaultContentLanguage = 'ko';
const defaultSiteLanguage = 'ko';
const baseURL = 'https://goodjin.kr/';
...
const quickLinks = '결과';
const searchResultsLabel = '검색 결과';
const shortSearchQuery = '너무 짧습니다'
const typeToSearch = '검색어를 입력해주세요';
const noMatchesFound = '결과를 찾을 수 없습니다';
